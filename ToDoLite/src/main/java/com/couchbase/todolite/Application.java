...
public class Application extends android.app.Application {
    ...
    private void initDatabase() {
        try {
            ...
            Log.e(TAG, "Cannot init Manager object", e);
        }
    ...
    public void onCreate() {
        ...
        initDatabase();
        preferences.setCurrentUserId("dave");

        try {
            Document doc = Profile.createProfile(database, "dave", "David Henry");
            Log.d(TAG, "profile created:" + doc.getProperties());
        } catch (CouchbaseLiteException e) {
